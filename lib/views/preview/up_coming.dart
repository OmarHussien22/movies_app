...
class UpComingPreviewScreen extends StatefulWidget {
  final int index;
  final HomeLayoutCubit cubit;

  const UpComingPreviewScreen(this.cubit, this.index, {super.key});

  @override
  State<UpComingPreviewScreen> createState() => _UpComingPreviewScreenState();
}

class _UpComingPreviewScreenState extends State<UpComingPreviewScreen> {
  @override
  void initState() {
    super.initState();
    ...
    return BlocBuilder<HomeLayoutCubit, HomeLayoutState>(
      ...
      builder: (context, state) {
        return Conditional.single(
          context: context,
          conditionBuilder: (context) => cubit.upComingModel!.result.isNotEmpty,
          widgetBuilder: (context) => Scaffold(
            ...
            appBar: AppBar(
              centerTitle: true,
              title: AutoSizeText(
                cubit.upComingModel!.result[widget.index].title,
                minFontSize: 17,
                maxFontSize: 25,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Card(
                                      ...
                                      child: FadeInImage.assetNetwork(
                                          ...
                                          image:
                                              '$imageUrl${cubit.upComingModel!.result[widget.index].inSideImage}'),
                                    ),
                                  )),
                              Expanded(
                                  flex: 1,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          AutoSizeText(
                                            '${cubit.upComingModel!.result[widget.index].voteAverage}',
                                            textAlign: TextAlign.center,
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyLarge,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: AutoSizeText(
                              cubit
                                  .upComingModel!.result[widget.index].overView,
                              minFontSize: 17,
                              maxFontSize: 22,
