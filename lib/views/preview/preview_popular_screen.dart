...
class PopularPreviewScreen extends StatefulWidget {
  const PopularPreviewScreen(this.index, this.cubit, {super.key});
  final int index;
  final HomeLayoutCubit cubit;

  @override
  State<PopularPreviewScreen> createState() => _PopularPreviewScreenState();
}

class _PopularPreviewScreenState extends State<PopularPreviewScreen> {
  @override
  void initState() {
    super.initState();
    ...
    if (cubit.videosModel == null) {
      cubit.getPopularVideos(
          videosId: widget.cubit.popularModel!.result[widget.index].id);
    }
  }
    ...
    return BlocBuilder<HomeLayoutCubit, HomeLayoutState>(
      ...
      builder: (context, state) {
        return Conditional.single(
          context: context,
          conditionBuilder: (context) => cubit.popularModel!.result.isNotEmpty,
          widgetBuilder: (context) => Scaffold(
            appBar: AppBar(
              centerTitle: true,
              title: AutoSizeText(
                '${cubit.popularModel!.result[widget.index].title}',
                minFontSize: 17,
                maxFontSize: 25,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Card(
                                      ...
                                      child: FadeInImage.assetNetwork(
                                          ...
                                          image:
                                              '$imageUrl${cubit.popularModel!.result[widget.index].inSideImage}'),
                                    ),
                                  )),
                              Expanded(
                                  flex: 1,
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      AutoSizeText(
                                        '${cubit.popularModel!.result[widget.index].releaseDate}',
                                        textAlign: TextAlign.center,
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodySmall,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          AutoSizeText(
                                            '${cubit.popularModel!.result[widget.index].voteAverage}',
                                            textAlign: TextAlign.center,
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodyLarge,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: AutoSizeText(
                              '${cubit.popularModel!.result[widget.index].overView}',
                              minFontSize: 17,
                              maxFontSize: 22,
